...
namespace Notepads.Controls.Print
{
    ...
    {
        public ContinuationPage(RichTextBlockOverflow textLinkContainer, FontFamily textEditorFontFamily, double textEditorFontSize, string headerText, string footerText)
        {
            InitializeComponent();
